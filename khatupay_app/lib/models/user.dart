class KPUser {
  ...
  KPUser({required this.id, required this.name, required this.email, required this.mobile, required this.emailVerified, required this.roles, required this.loanLimit});
